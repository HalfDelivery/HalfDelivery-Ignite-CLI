...
const Img = styled.Image`
  ...
  border-width: ${({ name, selectedName }) => (name === selectedName ? 1.5 : 0)}px;
...
const Gothic14 = styled.Text`
  ...
  margin-top: 12px;
  color: ${({ name, selectedName }) => (name === selectedName ? colors.primaryBlue : "black")};
...
const PinkHighlight = styled.View`
  margin-top: -7px;
  width: ${({ name }) => (name === "배달의 민족" ? "68px" : name === "요기요" ? "40px" : "54px")};
  height: 7px;
