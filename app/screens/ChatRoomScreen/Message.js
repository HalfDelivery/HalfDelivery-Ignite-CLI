...
import { ActivityIndicator, StyleSheet, Text, View, Image, useWindowDimensions } from "react-native"
...
const Message = ({ user, message, masterId, isMe = false }) => {
    ...
    <View style={[styles.container, isMe ? styles.rightContainer : styles.leftContainer]}>
      <View style={{ flexDirection: "row" }}>
        ...
        {!isMe && (
          <ProfileView>
            <ProfileImg
              source={user?.imageUri ? { uri: user.imageUri } : require("./default_prf_img.png")}
              isMaster={isMaster}
            />
          </ProfileView>
        )}
        ...
        <View>
          ...
          {!!message && (
            <MsgBox isMe={isMe} width={width} isMaster={isMaster}>
              ...
              <MsgText isMe={isMe}>{message}</MsgText>
            </MsgBox>
          )}
        </View>
