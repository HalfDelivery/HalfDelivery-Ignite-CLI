...
const MessageInput = ({ chatRoom, me, addMessage, users }) => {
    ...
    >
      ...
      <InputBox>
        ...
        <PlusBox onPress={expandBtm}>
          <PlusImg source={require("./plus.png")} />
        </PlusBox>
        <View style={styles.inputContainer}>
          ...
          <SendMsgBox onPress={onPress}>
            <SendMsgImg source={require("./send_message.png")} />
          </SendMsgBox>
        </View>
      ...
      {isBtm && (
        <Btm>
          ...
          >
            <Image source={require("./cam_alb.png")} style={{ width: 83, height: 96 }} />
          </Pressable>

          {/* 매칭 정보  */}
          <Pressable onPress={() => {}}>
            <Image source={require("./matching_info.png")} style={{ width: 83, height: 96 }} />
          </Pressable>
          ...
          >
            <Image source={require("./send_account.png")} style={{ width: 83, height: 96 }} />
          </Pressable>

          {/* 연락처 전송  */}
          <Pressable onPress={() => {}}>
            <Image source={require("./send_contact.png")} style={{ width: 83, height: 96 }} />
          </Pressable>
        </Btm>
      )}
